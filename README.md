...
- Link - https://haeke.github.io/twitch-example
- This app shows the presence of a list of broadcasters if they are online.
- The Twitch API is queried to get the information displayed such as name, description, avatar and URL.
- AJAX calls were made using the axios library.
- The UI was built using React and semantic-ui-react.
